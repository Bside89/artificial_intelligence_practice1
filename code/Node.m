...
%
% Cada nó de contém uma referência para o nó que o descobriu (i.e., nó
% visitado no passo anterior), o estado atual (i.e., configuração da
% matriz) e o número de movimentos feitos até o momento.
%
...
% do nó. O custo do nó é igual ao número de passos efetivamente
% percorridos pelo algoritmo até sua descoberta (i.e., o custo de um nó
% não-raiz é 1 (um) mais o custo do nó que descobriu).
%
...
classdef Node < handle
    ...
    methods
        ...
        function[out] = eq(obj,obj2)
            ...
            out = strcmp(class(obj),class(obj2)) &&  sum(sum(obj.State == obj2.State)) == 9;
        end
